    ...
    <div class="row mt-2">
      ...
      <div class="col-md-8">
        <input
          ...
          onChange={(e)=>{ setDataStock({...dataStock ,refMateriel: e.target.value}) }}
          onBlur={()=>checkRef(dataStock.refMateriel)}
        />
        <div id='msgErr' style={{color:'red',display:isdispo ? 'block':'none'}}>Ce Reference existe deja</div>
      </div>
    </div>
    <div class="row mt-2">
      ...
      <div class="col-md-8">
        <input
          ...
          onChange={(e)=>{ setDataStock({...dataStock ,designation: e.target.value}) }}
        />
      </div>
    </div>
    ...
    <div class="row mt-2">
      ...
      <div class="col-md-8">
        <input
          ...
          onChange={(e)=>{ setDataStock({...dataStock ,lieu: e.target.value}) }}
        />
      </div>
    </div>
    <div class="row mt-2">
    ...
    <div id="GE" style={{display: displayBloc.GE}}>
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          ...
          onChange={(e)=>{ setDetailGE({...detailGE ,puissance: e.target.value}) }}
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          <input
            ...
            onChange={(e)=>{ setDetailGE({...detailGE ,marque: e.target.value}) }}
          />
        </div>
      </div>
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          <input
            ...
            onChange={(e)=>{ setDetailGE({...detailGE ,dimension: e.target.value}) }}
          />
        </div>
      </div>
      <div class="row mt-3">
        <input type="submit" disabled={btnSabmit} class="btn btn-success" value="Enregistrer" />
      </div>
    </div>
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          <input
            ...
            onChange={(e)=>{ setDetailCAB({...detailCAB ,gamme: e.target.value}) }}
          />
        </div>
      </div>
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          <input
            ...
            onChange={(e)=>{ setDetailCAB({...detailCAB ,dimension: e.target.value}) }}
          />
        </div>
      </div>
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          <input
            ...
            onChange={(e)=>{ setDetailCAB({...detailCAB ,color: e.target.value}) }}
          />
        </div>
      </div>
      <div class="row mt-3">
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          <input
            ...
            onChange={(e)=>{ setDetailMOD({...detailMOD ,gamme: e.target.value}) }}
          />
        </div>
      </div>
      <div class="row mt-2">
        ...
        <div class="col-md-8">
          <input
            ...
            onChange={(e)=>{ setDetailMOD({...detailMOD ,dimension: e.target.value}) }}
          />
        </div>
      </div>
      <div class="row mt-3">
        <input  type="submit" class="btn btn-success" value="Enregistrer" disabled={btnSabmit}/>
